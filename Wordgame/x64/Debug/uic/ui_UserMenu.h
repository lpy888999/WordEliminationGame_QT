...
public:
    ...
    void setupUi(QMainWindow *UserMenuClass)
    {
        ...
        Connect->setGeometry(QRect(60, 630, 112, 34));
        p2 = new QLabel(centralWidget);
        p2->setObjectName(QString::fromUtf8("p2"));
        p2->setGeometry(QRect(60, 700, 161, 31));
    ...
    void retranslateUi(QMainWindow *UserMenuClass)
    {
        ...
        Connect->setText(QCoreApplication::translate("UserMenuClass", "\345\214\271\351\205\215", nullptr));
        p2->setText(QString());
    } // retranslateUi
